...
AFRAME.registerComponent('environment', {
  schema: {
    preset: {default: 'default', oneOf: ['none', 'default', 'contact', 'egypt', 'checkerboard', 'forest', 'goaland', 'yavapai', 'goldmine', 'arches', 'threetowers', 'poison', 'japan', 'dream', 'starry', 'osiris']},
  ...
  presets: {
    ...
    'goaland': {seed: 17, skyType: "gradient", skyColor: "#239893", horizonColor: "#a3dab8", lights: "room", lightPosition: { x: 0.1, y: 4, z: 0.56}, fog: 0.73, flatShading: false, playArea: 1, ground: "noise", groundYScale: 0.81, groundTexture: "none", groundColor: "#E95867", groundColor2: "#db4453", dressing: "mushrooms", dressingAmount: 150, dressingColor: "#df5361", dressingScale: 5, dressingVariance: { x: 5, y: 10, z: 5}, dressingUniformScale: true, dressingOnPlayArea: 0, grid: "dots", gridColor: "#239893"},
    ...
    'threetowers': {seed: 5, skyType: "gradient", skyColor: "#23a06b", horizonColor: "#f5e170", lights: "sun", lightPosition: { x: 0.5, y: 1, z: 0}, fog: 0.8, flatShading: false, playArea: 1, ground: "spikes", groundYScale: 4.26, groundTexture: "walkernoise", groundColor: "#273a49", groundColor2: "#2b464f", dressing: "towers", dressingAmount: 3, dressingColor: "#5f6d94", dressingScale: 20, dressingVariance: { x: 5, y: 100, z: 5}, dressingUniformScale: true, dressingOnPlayArea: 0, grid: "none", gridColor: "#239893"},
    'poison': {seed: 92, skyType: "gradient", skyColor: "#1ea84a", horizonColor: "#177132", lights: "sun", lightPosition: { x: 0.5, y: 1, z: 0}, fog: 0.8, flatShading: false, playArea: 1, ground: "canyon", groundYScale: 9.76, groundTexture: "none", groundColor: "#851f31", groundColor2: "#912235", dressing: "cubes", dressingAmount: 20, dressingColor: "#c7415b", dressingScale: 10, dressingVariance: { x: 1, y: 200, z: 1}, dressingUniformScale: false, dressingOnPlayArea: 0, grid: "crosses", gridColor: "#de4e67"},
    'arches': {seed: 52, skyType: "atmosphere", skyColor: "#8cbdc8", horizonColor: "#ddd", lights: "sun", lightPosition: { x: -0.11, y: 0.16, z: 0.33}, fog: 0.67, flatShading: true, playArea: 1, ground: "canyon", groundYScale: 10, groundTexture: "walkernoise", groundColor: "#a87d6f", groundColor2: "#795449", dressing: "arches", dressingAmount: 6, dressingColor: "#795449", dressingScale: 26.13, dressingVariance: { x: 20, y: 40, z: 20}, dressingUniformScale: true, dressingOnPlayArea: 0, grid: "none", gridColor: "#ccc"},
