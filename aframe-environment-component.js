...
AFRAME.registerComponent('environment', {
  schema: {
    preset: {default: 'default', oneOf: ['none', 'default', 'contact', 'egypt', 'checkerboard', 'forest', 'goaland', 'yavapai', 'threetowers', 'poison', 'starry', 'osiris', 'japan']},
  ...
  presets: {
    'none' : {},
    'default' : {seed: 1, skyType: "atmosphere", skyColor: "#88c", horizonColor: "#ddd", lights: 'sun', lightPosition: { x: -0.11, y: 1, z: 0.33}, fog: 0.78, flatShading: false, playArea: 1, ground: "hills", groundYScale: 3, groundTexture: "checkerboard", groundColor: "#454545", groundColor2: "#5d5d5d", dressing: "none", dressingAmount: 0, dressingColor: "#795449", dressingScale: 1, dressingVariance: { x: 0, y: 0, z: 0}, dressingUniformScale: true, grid: "none", gridColor: "#ccc"},
    ...
    'japan': {seed: 14, skyType: "gradient", skyColor: "#7e5db5", horizonColor: "#cabdf5", lights: "sun", lightPosition: { x: 0.85, y: 1, z: 1}, fog: 0.8, flatShading: false, playArea: 1, ground: "hills", groundYScale: 10, groundTexture: "walkernoise", groundColor: "#7e5db5", groundColor2: "#cabdf5", dressing: "torii", dressingAmount: 4, dressingColor: "#bc5e7c", dressingScale: 15, dressingVariance: { x: 0, y: 0, z: 0}, dressingUniformScale: true, grid: "spots", gridColor: "#e4b676"}
  },
